...
export const ru: T = {
  ...
  playOnKeyboardLabel: '🎹 Сыграй ноту',
  ...
  supportTitle: 'Бонусные очки',
  supportIntro: 'Посмотрите короткую рекламу и получите бонусные очки для таблицы лидеров.',
  watchAdLabel: 'Смотри рекламу — получай очки',
  watchAdDesc: 'Несколько секунд — и очки ваши',
  watchAdLoading: 'Загрузка рекламы...',
  watchAdThanks: 'Отлично! Очки получены 🎉',
  watchAdError: 'Не удалось загрузить рекламу сейчас. Попробуйте позже.',
  watchAdPointsEarned: 'Вы получили {points} очков!',
  supportTierTitle: 'Поддержать приложение',
  supportTierIntro: 'Выберите сумму, чтобы поддержать разработку. Любая покупка даёт значок Music Patron.',
  supportPatronActive: 'Вы Music Patron — спасибо!',
  supportSignInRequired: 'Войдите, чтобы поддержать приложение и получить значок Music Patron.',
  supportStoreUnavailable: 'Магазин сейчас недоступен. Попробуйте ещё раз через мгновение.',
  ...
  leaderboardIntro: 'Зарабатывайте очки, тренируясь (1 очко в минуту) и просматривая рекламу (по 2 очка), и соревнуйтесь с другими пользователями.',
