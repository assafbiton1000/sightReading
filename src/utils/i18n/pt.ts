...
export const pt: T = {
  ...
  playOnKeyboardLabel: '🎹 Toque a nota',
  ...
  forumSignInPrompt: 'Faça login para publicar perguntas e respostas.',
  timeJustNow: 'agora',
  timeMinAgo: 'há {n} min',
  timeHourAgo: 'há {n} h',
  timeDayAgo: 'há {n} d',
  ...
  supportTitle: 'Pontos bônus',
  supportIntro: 'Assista a um anúncio curto e ganhe pontos bônus para o ranking.',
  watchAdLabel: 'Assista a um anúncio e ganhe pontos',
  watchAdDesc: 'Alguns segundos — e os pontos são seus',
  watchAdLoading: 'Carregando anúncio...',
  watchAdThanks: 'Ótimo! Pontos recebidos 🎉',
  watchAdError: 'Não foi possível carregar um anúncio agora. Tente novamente mais tarde.',
  watchAdPointsEarned: 'Você ganhou {points} pontos!',
  supportTierTitle: 'Apoie o app',
  supportTierIntro: 'Escolha um valor para apoiar o desenvolvimento. Qualquer compra dá a você o selo Music Patron.',
  supportPatronActive: 'Você é Music Patron — obrigado!',
  supportSignInRequired: 'Entre para apoiar o app e receber o selo Music Patron.',
  supportStoreUnavailable: 'A loja não está disponível agora. Tente novamente em instantes.',
  ...
  leaderboardIntro: 'Ganhe pontos praticando (1 por minuto) e assistindo a anúncios (2 cada), e compita com outros usuários.',
  ...
  rankIntermediate: 'Intermediário',
  rankAdvanced: 'Avançado',
  rankExpert: 'Especialista',
  rankMaster: 'Mestre',

  startPlayingHint: 'Comece a tocar',
};
