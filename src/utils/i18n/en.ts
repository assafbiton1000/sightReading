...
export const en: T = {
  ...
  playOnKeyboardLabel: '🎹 Play the note',
  ...
  forumSignInPrompt: 'Sign in to post questions and replies.',
  ...
  supportTitle: 'Bonus Points',
  supportIntro: 'Watch a short ad and earn bonus points for the leaderboard.',
  watchAdLabel: 'Watch an ad, earn points',
  watchAdDesc: 'A few seconds — and the points are yours',
  watchAdLoading: 'Loading ad...',
  watchAdThanks: 'Great! Reward earned 🎉',
  watchAdError: "Couldn't load an ad right now. Please try again later.",
  watchAdPointsEarned: 'You got {points} points!',
  supportTierTitle: 'Support the app',
  supportTierIntro: 'Choose an amount to support development. Any purchase gives you the Music Patron badge.',
  supportPatronActive: "You're a Music Patron — thank you!",
  supportSignInRequired: 'Sign in to support the app and receive the Music Patron badge.',
  supportStoreUnavailable: "The store isn't available right now. Please try again in a moment.",
  ...
  leaderboardIntro: 'Earn points by practicing (1 per minute) and watching ads (2 each), and compete with other users.',
