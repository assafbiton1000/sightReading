...
export const fr: T = {
  ...
  leaderboardIntro: "Gagnez des points en vous entraînant (1 par minute) et en regardant une publicité de soutien (0,5 chacune), et affrontez d'autres utilisateurs.",
