...
export const de: T = {
  ...
  waitingLabel: '🎤 Warten...',
  playOnKeyboardLabel: '🎹 Spiele die Note',
  ...
  supportTitle: 'Bonuspunkte',
  supportIntro: 'Sieh dir eine kurze Werbung an und erhalte Bonuspunkte für die Bestenliste.',
  watchAdLabel: 'Werbung ansehen, Punkte erhalten',
  watchAdDesc: 'Ein paar Sekunden — und die Punkte gehören dir',
  watchAdLoading: 'Werbung wird geladen...',
  watchAdThanks: 'Super! Punkte erhalten 🎉',
  ...
  supportTierTitle: 'Unterstütze die App',
  supportTierIntro: 'Wähle einen Betrag, um die Entwicklung zu unterstützen. Jeder Kauf gibt dir das Music-Patron-Abzeichen.',
  supportPatronActive: 'Du bist Music Patron — danke!',
  supportSignInRequired: 'Melde dich an, um die App zu unterstützen und das Music-Patron-Abzeichen zu erhalten.',
  supportStoreUnavailable: 'Der Store ist gerade nicht verfügbar. Bitte versuche es gleich noch einmal.',
  ...
  leaderboardIntro: 'Sammle Punkte durch Üben (1 pro Minute) und durch Ansehen von Werbung (je 2), und tritt gegen andere Nutzer an.',
