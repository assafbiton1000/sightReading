...
export const es: T = {
  ...
  forumPendingApproval: 'Tu mensaje se envió y está pendiente de aprobación por un moderador.',
  deleteBtn: 'Eliminar',
  ...
  supportTierTitle: 'Apoya la app',
  supportTierIntro: 'Elige un importe para apoyar el desarrollo. Cualquier compra te da la insignia Music Patron.',
  supportPatronActive: 'Eres Music Patron: ¡gracias!',
  supportSignInRequired: 'Inicia sesión para apoyar la app y recibir la insignia Music Patron.',
  supportStoreUnavailable: 'La tienda no está disponible ahora. Inténtalo de nuevo en un momento.',
