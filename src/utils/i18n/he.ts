...
export const he: T = {
  ...
  waitingLabel: '🎤 מחכה...',
  playOnKeyboardLabel: '🎹 נגנו את התו',
  correctExclaim: '✓ נכון!',
  ...
  supportTitle: 'נקודות בונוס',
  supportIntro: 'צפו בפרסומת קצרה וקבלו נקודות בונוס לטבלת המובילים.',
  watchAdLabel: 'צפו בפרסומת וקבלו נקודות',
  watchAdDesc: 'כמה שניות — והנקודות שלכם',
  watchAdLoading: 'טוען פרסומת...',
  watchAdThanks: 'מעולה! הנקודות נוספו 🎉',
  watchAdError: 'לא הצלחנו לטעון פרסומת כרגע. נסו שוב מאוחר יותר.',
  watchAdPointsEarned: 'קיבלת {points} נקודות!',
  supportTierTitle: 'תמכו באפליקציה',
  supportTierIntro: 'בחרו סכום לתמיכה בפיתוח. כל רכישה מקנה לכם את תג ה-Music Patron.',
  supportPatronActive: 'אתם Music Patron — תודה רבה!',
  supportSignInRequired: 'התחברו כדי לתמוך באפליקציה ולקבל את תג ה-Music Patron.',
  supportStoreUnavailable: 'החנות אינה זמינה כרגע. נסו שוב בעוד רגע.',
  ...
  leaderboardIntro: 'צברו נקודות מתרגול (דקה = נקודה) ומצפייה בפרסומות (2 נקודות לצפייה), והתחרו עם משתמשים אחרים.',
